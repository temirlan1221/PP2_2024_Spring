...
print("Interheice Status")
print("==========================================================================")
print("DN                                            Description    speed      mtu" )
mtu = a["imdata"][0]["l1PhysIf"]["attributes"]["mtu"]
speed = a["imdata"][0]["l1PhysIf"]["attributes"]["speed"]
dn = a["imdata"][0]["l1PhysIf"]["attributes"]["dn"]
print(dn +"                   " +  speed + "     "+ mtu)
mtu = a["imdata"][1]["l1PhysIf"]["attributes"]["mtu"]
speed = a["imdata"][1]["l1PhysIf"]["attributes"]["speed"]
dn = a["imdata"][1]["l1PhysIf"]["attributes"]["dn"]
print(dn +"                   " +  speed + "     "+ mtu)
mtu = a["imdata"][2]["l1PhysIf"]["attributes"]["mtu"]
speed = a["imdata"][2]["l1PhysIf"]["attributes"]["speed"]
dn = a["imdata"][2]["l1PhysIf"]["attributes"]["dn"]
print(dn +"                   " +  speed + "     "+ mtu)
